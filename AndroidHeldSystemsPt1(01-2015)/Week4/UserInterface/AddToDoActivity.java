	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intentCancel = new Intent(getApplicationContext(), ToDoManagerActivity.class);
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int prioritySelected = mPriorityRadioGroup.getCheckedRadioButtonId();
				Priority priority = Priority.values()[mPriorityRadioGroup.indexOfChild(findViewById(prioritySelected))];

				// TODO - Get the current Status
				RadioButton radioButton = (RadioButton)findViewById(mStatusRadioGroup.getCheckedRadioButtonId());

				Status status = null;
				if (radioButton.getText().equals(getString(R.string.done_string))) {
					status = Status.DONE;
				} else {
